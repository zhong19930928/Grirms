...
public class SurveyMySelfView implements OnClickListener{
	...
	public SurveyMySelfView(Context context) {
		...
		.build();
		view = View.inflate(context, R.layout.activity_survey_myself_item, null);

		tv_survey_myself_name = (TextView) view.findViewById(R.id.tv_survey_myself_name);
		tv_survey_myself_content = (TextView) view.findViewById(R.id.tv_survey_myself_content);
