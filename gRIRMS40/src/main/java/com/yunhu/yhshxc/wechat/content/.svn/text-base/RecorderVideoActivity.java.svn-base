...
public class RecorderVideoActivity extends AbsBaseActivity implements
	...
	public void onClick(View view) {
		...
		case R.id.recorder_start:
			// start recording
			startRecording();
			Toast.makeText(this, R.string.wechat_content91, Toast.LENGTH_SHORT).show();
		...
		case R.id.recorder_stop:
			...
			new AlertDialog.Builder(this)
					.setMessage(R.string.wechat_content90)
					.setPositiveButton(R.string.wechat_content89,
					...
					.setNegativeButton(R.string.wechat_content88,
							new DialogInterface.OnClickListener() {
...
//				+ System.currentTimeMillis() + ".mp4";
		...
		localPath = Constants.WECHAT_PATH_LOAD + System.currentTimeMillis() + ".mp4";
		JLog.d("jishen", "videPath:"+localPath);
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			new AlertDialog.Builder(this)
					.setMessage(R.string.wechat_content87)
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				...
				.setMessage(R.string.wechat_content86)
