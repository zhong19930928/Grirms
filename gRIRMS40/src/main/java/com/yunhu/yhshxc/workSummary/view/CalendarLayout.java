...
//        mViewDragHelper.shouldInterceptTouchEvent(ev);
    ...
    private boolean isScroll(ViewGroup view2) {
        ...
        if (view2 instanceof ScrollView) {
            ScrollView list = (ScrollView) view2;
            if (fistChildView.getTop() != 0) {
                return true;
            } else {
                if (list.getScrollY() != 0) {
                    return true;
                }
            }
        }
    ...
    private OnOpenChangeListener openListener;

    public void setOpenChangeListener(OnOpenChangeListener listener) {
