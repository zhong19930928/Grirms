...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR =0xFF5E5F60;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF5E5F60;

	/** Top and bottom shadows colors */
	private static final int[] SHADOWS_COLORS = new int[] { 0x00D7F6F9,
	...
	private static final int ITEM_OFFSET = TEXT_SIZE / 4;
	...
	private void initResourcesIfNecessary() {
		int text_size = this.getResources().getDimensionPixelSize(R.dimen.wheel_text_size);
		if (itemsPaint == null) {
