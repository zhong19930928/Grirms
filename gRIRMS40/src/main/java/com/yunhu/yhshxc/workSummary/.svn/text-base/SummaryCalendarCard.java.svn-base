...
public class SummaryCalendarCard extends RelativeLayout {
	...
	public SummaryCalendarCard(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public SummaryCalendarCard(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public SummaryCalendarCard(Context context) {
		super(context);
		init(context);
	}
	...
	private void init(Context ctx) {
		if (isInEditMode())
			return;
		View layout = LayoutInflater.from(ctx).inflate(R.layout.summary_card_view,
				null, false);
