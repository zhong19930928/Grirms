...
public class MediaManager extends Menu implements OnClickListener{
	private final String TAG="RecordPreviewDataComp";
	private TextView tv_time;
	private View view;
	private ImageView playBtn;//播放 暂停按钮
	...
	public MediaManager(Context context,String value) {
		this.mContext=context;
		view = View.inflate(context, R.layout.record_button_view, null);
		tv_time = (TextView) view.findViewById(R.id.tv_record_priview_time);
		playBtn=(ImageView)view.findViewById(R.id.iv_record_play);
...
//				playBtn.setText("播放");
				playBtn.setImageDrawable(mContext.getResources().getDrawable(R.drawable.func_pause));
				pause();
			}else{
				play();
//				playBtn.setText("暂停");
				playBtn.setImageDrawable(mContext.getResources().getDrawable(R.drawable.func_player));
...
//					playBtn.setText("播放");
			...
			mediaPlayer.setOnErrorListener(new OnErrorListener() {
				...
				public boolean onError(MediaPlayer mp, int what, int extra) {
					...
					Toast.makeText(mContext, mContext.getResources().getString(R.string.play_fail), Toast.LENGTH_SHORT).show();
					stopPlay();
					return false;
				}
			});
