package com.yunhu.yhshxc.widget.pulltorefreshview;
 ...
 * 
 */
public class HeaderPullToRefreshView extends LinearLayout {
	...
	public HeaderPullToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public HeaderPullToRefreshView(Context context) {
		super(context);
		init();
	}
...
//				footerPrepareToRefresh(deltaY);
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText(R.string.release_refresh_now);
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterTextView.setText(R.string.release_load_now);
			...
			mFooterImageView.clearAnimation();
			mFooterImageView.startAnimation(mFlipAnimation);
			mFooterTextView.setText(R.string.pull_on_load);
	...
	private void headerRefreshing() {
		...
		mHeaderTextView.setText(R.string.refresh_now);
	...
	private void footerRefreshing() {
		...
		mFooterTextView.setText(R.string.loading_);
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(HeaderPullToRefreshView view);
	}
