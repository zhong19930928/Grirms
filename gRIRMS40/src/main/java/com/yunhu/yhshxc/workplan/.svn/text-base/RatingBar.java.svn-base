...
public class RatingBar extends LinearLayout {
	...
	private float currentRatingCount = 0;// 当前选中的星星数目
	...
	private ImageView getStarImageView() {
		...
		LinearLayout.LayoutParams layout = new LinearLayout.LayoutParams(Math.round(starImageSize),
				Math.round(starImageSize));// 设置每颗星星在线性布局的大小
...
//	}
	 ...
	 * 获取当前选中的星星数目
	 */
	public int getSelectRatingCount() {
		return (int) currentRatingCount;
	}
...
//	 * 设置星星展示总数
//	 */
	public void setStartCount(int starCount) {
	...
	/**
	 * 星星每次增加的方式整星还是半星，枚举类型 类似于View.GONE
	 */
