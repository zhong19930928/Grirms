...
//        	View view = (View) horizontalScrollView.getChildAt(horizontalScrollView.getChildCount() - 1);
//			int subViewWidth = view.getRight();
//
//			//获取scrollview的滚动位置
//			int x_ = horizontalScrollView.getScrollX();
//			int move = subViewWidth - x_ - horizontalScrollView.getWidth();
//			Log.i("jishen", "move:"+move + " subViewWidth:"+subViewWidth +" x_:"+x_ + " dx:"+dx);
//			if (move == 0) {
