...
public class ZRMduleMenuAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    private List<Menu> list;
    private ViewHolder viewHolder;
    private Context mContext;

    public ZRMduleMenuAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.zrmodule_menu_list_item, null);
            viewHolder.iv_icon = (ImageView) convertView.findViewById(R.id.zrmodule_menu_icon);
            viewHolder.textView = (TextView) convertView.findViewById(R.id.zrmodule_menu_name);
        ...
        if (list.get(position).getIcon() != null) {
            ...
            if (list.get(position).getName().equals("领用")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_lingyong);
            } else if (list.get(position).getName().equals("退库")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_tuihui);
            } else if (list.get(position).getName().equals("借用")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_jieyong);
            } else if (list.get(position).getName().equals("归还")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_guihuan);
            } else if (list.get(position).getName().equals("查询修改")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_luru);
            } else if (list.get(position).getName().equals("调拨")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_diaobo);
            } else if (list.get(position).getName().equals("盘点")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_pandian);
            } else if (list.get(position).getName().equals("我的单据")) {
                viewHolder.iv_icon.setBackgroundResource(R.drawable.asset_danju);
            }
        }
        return convertView;
    }
