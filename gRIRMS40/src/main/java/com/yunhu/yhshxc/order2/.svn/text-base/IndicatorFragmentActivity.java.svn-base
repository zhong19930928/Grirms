...
import com.yunhu.yhshxc.order2.view.TitleIndicator;
import com.yunhu.yhshxc.order2.view.ViewPagerCompat;
import com.yunhu.yhshxc.widget.DropDown.OnFuzzyQueryListener;

@SuppressWarnings("static-access")
public abstract class IndicatorFragmentActivity extends FragmentActivity implements OnPageChangeListener,OnFuzzyQueryListener {
...
//        mPager.setPageMargin(getResources().getDimensionPixelSize(R.dimen.page_margin_width));
    ...
    private final void initViews() {
        ...
        mPager = (ViewPagerCompat) findViewById(R.id.pager);
