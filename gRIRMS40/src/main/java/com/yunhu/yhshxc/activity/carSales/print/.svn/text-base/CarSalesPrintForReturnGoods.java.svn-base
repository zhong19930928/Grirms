...
public class CarSalesPrintForReturnGoods extends AbsCarSalesPrint {
	private CarSales carSales;
	public CarSalesPrintForReturnGoods(Context context) {
		super(context);
	}
	@Override
...
//						e.setContent(SharedPreferencesUtil.getInstance(context).getCompanyName());
					...
					case 17://退款
						e.setContent(PublicUtils.formatDouble(carSales.getReturnAmount())+ " 元");
						break;
					case 18://留言
