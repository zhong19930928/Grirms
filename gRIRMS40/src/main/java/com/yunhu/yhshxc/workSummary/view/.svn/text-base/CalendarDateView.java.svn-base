...
import static com.yunhu.yhshxc.workSummary.view.CalendarFactory.getMonthOfDayList;

public class CalendarDateView extends ViewPager implements CalendarTopView {

	HashMap<Integer, CalendarView> views = new HashMap<Integer, CalendarView>();
		...
		addOnPageChangeListener(new SimpleOnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				...
				if (onItemClickListener != null) {
					...
					onItemClickListener.onItemClick((View) obs[0], (Integer) obs[1], (CalendarBean) obs[2]);
				}
