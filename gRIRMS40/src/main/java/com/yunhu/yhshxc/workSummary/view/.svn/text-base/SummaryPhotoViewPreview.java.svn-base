...
public class SummaryPhotoViewPreview implements OnClickListener {
...
//	}
	...
	public void setPhotoView( final Photo photo) {
		...
		imageLoader.displayImage(photo.getPhotoPath(), iv_photo_items, options, null);
		...
		.setPositiveButton(R.string.Confirm,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog,
							int which) {
						contentControlListener.contentControl(SummaryPhotoViewPreview.this);
						dialog.dismiss();
					}
				})
