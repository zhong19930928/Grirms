 ...
 *
 */
public class ShowImageActivity extends AbsBaseActivity {
	// 图片下载完毕
	...
	private Handler mHandler = new Handler(){
		public void handleMessage(Message msg) {
			...
			case LOAD_IMAGE_FAIL:
				ToastOrder.makeText(ShowImageActivity.this, setString(R.string.activity_after_16), 1).show();
		...
		new Thread(){
			public void run() {
				try {
					...
					HttpHelper httpHelper = new HttpHelper(ShowImageActivity.this);
					// 获取entity
