...
import com.yunhu.yhshxc.order3.Order3HomeActivity;
import com.yunhu.yhshxc.order3.Order3SearchActivity;
...
public class ApprovalLeaveActivity extends AbsBaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tv_attend_leave.setText(PublicUtils.getResourceString(this,R.string.leave_m));
		List<Module> list = new ArrayList<Module>();
		Module create = new Module();
		create.setName(PublicUtils.getResourceString(this,R.string.leave_m1));
		create.setType(Constants.MODULE_TYPE_REPORT);
		list.add(create);
		Module search = new Module();
		search.setName(PublicUtils.getResourceString(this,R.string.leave_m2));
...
//						ll_order3_layout.addView(item, lp);//将自定义的view添加到父view中
	...
	private void create() {
		Intent intent = new Intent(ApprovalLeaveActivity.this,Order3HomeActivity.class);
		
		startActivity(intent);
	}
	private void search() {
		Intent intent = new Intent(ApprovalLeaveActivity.this,Order3SearchActivity.class);
