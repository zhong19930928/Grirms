...
public class ContentPhotoView implements OnClickListener {
	...
	public void setPhotoView(final Photo photo) {
		...
		imageLoader.displayImage("file://"+Constants.WECHAT_PATH_LOAD+photo.getPhotoPath(), iv_photo_items, options, null);
		...
		.setPositiveButton(R.string.Confirm,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog,
							int which) {
						contentControlListener.contentControl(ContentPhotoView.this);
						dialog.dismiss();
					}
				})
