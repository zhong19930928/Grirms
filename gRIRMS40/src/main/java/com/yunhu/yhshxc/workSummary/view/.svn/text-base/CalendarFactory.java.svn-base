...
import static com.yunhu.yhshxc.workSummary.view.CalendarUtil.getDayOfWeek;



public class CalendarFactory {

    private static HashMap<String, List<CalendarBean>> cache = new HashMap<String, List<CalendarBean>>();
