...
import static com.yunhu.yhshxc.MeetingAgenda.view.calendars.CalendarFactory.getMonthOfDayList;
...
public class CalendarDateView extends ViewPager implements CalendarTopView {
    ...
    private CalendarView.OnGetMonthListener onGetMonthListener;
    ...
    public void setOnGetMonthListener(CalendarView.OnGetMonthListener onGetMonthListener) {
        this.onGetMonthListener = onGetMonthListener;
    }
        ...
        addOnPageChangeListener(new SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (onItemClickListener != null) {
                    ...
                    if (onGetMonthListener!=null){
                        onGetMonthListener.onMonth((CalendarBean) obs[2]);
                    }
